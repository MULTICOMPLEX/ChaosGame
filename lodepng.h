...
Return value: LodePNG error code (0 means no error).
*/
unsigned lodepng_encode_memory(unsigned char** out, uint64_t* outsize,
                               const unsigned char* image, unsigned w, unsigned h,
                               LodePNGColorType colortype, unsigned bitdepth);

/*Same as lodepng_encode_memory, but always encodes from 32-bit RGBA raw image.*/
unsigned lodepng_encode32(unsigned char** out, uint64_t* outsize,
                          const unsigned char* image, unsigned w, unsigned h);

/*Same as lodepng_encode_memory, but always encodes from 24-bit RGB raw image.*/
unsigned lodepng_encode24(unsigned char** out, uint64_t* outsize,
                          const unsigned char* image, unsigned w, unsigned h);
...
struct LodePNGDecompressSettings {
  ...
  unsigned (*custom_zlib)(unsigned char**, uint64_t*,
  ...
  Should return 0 if success, any non-0 if error (numeric value not exposed).*/
  unsigned (*custom_inflate)(unsigned char**, uint64_t*,
                             const unsigned char*, uint64_t,
                             const LodePNGDecompressSettings*);
...
struct LodePNGCompressSettings /*deflate = compress*/ {
  ...
  unsigned (*custom_deflate)(unsigned char**, uint64_t*,
                             const unsigned char*, uint64_t,
                             const LodePNGCompressSettings*);
...
typedef struct LodePNGColorMode {
  ...
  */
  ...
  uint64_t palettesize; /*palette size in number of colors (amount of used bytes is 4 * palettesize)*/
...
typedef struct LodePNGInfo {
  ...
  */
  uint64_t text_num; /*the amount of texts in these char** buffers (there may be more texts in itext)*/
  ...
  */
  uint64_t itext_num; /*the amount of international texts in this PNG*/
  ...
  */
  ...
  uint64_t unknown_chunks_size[3]; /*size in bytes of the unknown chunks, given for protection*/
#endif /*LODEPNG_COMPILE_ANCILLARY_CHUNKS*/
} LodePNGInfo;
...
*/
unsigned lodepng_chunk_create(unsigned char** out, uint64_t* outsize, unsigned length,
                              const char* type, const unsigned char* data);


/*Calculate CRC32 of buffer*/
unsigned lodepng_crc32(const unsigned char* buf, uint64_t len);
#endif /*LODEPNG_COMPILE_PNG*/
...
*/
unsigned lodepng_zlib_decompress(unsigned char** out, uint64_t* outsize,
                                 const unsigned char* in, uint64_t insize,
                                 const LodePNGDecompressSettings* settings);
#endif /*LODEPNG_COMPILE_DECODER*/
...
buffer and *outsize its size in bytes. out must be freed by user after usage.
*/
unsigned lodepng_zlib_compress(unsigned char** out, uint64_t* outsize,
                               const unsigned char* in, uint64_t insize,
